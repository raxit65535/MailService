...
document.getElementById('bottom').innerHTML=val;
    ...
    <title>My JSP 'sent.jsp' starting page</title>
  ...
  String _flag = "0";
	...
	Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","root");
			PreparedStatement ps=con.prepareStatement("Select * from inbox28 where sender=? and flag = ?");
			...
			while(rs.next()){
				...
				out.print("<td><a href='form/deletesent.jsp?val1="+rs.getInt(1)+"'> Delete</a></td>");
